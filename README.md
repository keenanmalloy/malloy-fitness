...
- [Add an exercise to a workout](docs/workouts/post.md) : `POST /workouts/:pk/exercises/:pk/`
- [Update an exercises order / priority in a workout](docs/workouts/put.md) : `PUT /workouts/:pk/exercises/:pk/`
