  ...
  return (
    <Layout>
      ...
      <div className="border-b border-slate-400">
        <div className="h-32 flex justify-center pt-4"></div>
        <div className="flex justify-center border-b-2 border-solid rounded-sm border-slate-400 mx-3 pb-4">
          <div className="flex flex-col text-center text-slate-600">Cardio</div>
        </div>
      </div>

      <div className="border-b border-slate-400">
        <div className="h-16 flex justify-center pt-4"></div>
        <div className="flex justify-center border-b-2 border-solid rounded-sm border-slate-400 mx-3 pb-4">
          <div className="flex flex-col text-center text-slate-600">Sleep</div>
        </div>
      </div>
      ...
      <div className="border-b border-slate-400">
        <div className="h-16 flex justify-center pt-4"></div>
        <div className="flex justify-center border-b-2 border-solid rounded-sm border-slate-400 mx-3 pb-4">
          <div className="flex flex-col text-center text-slate-600">Steps</div>
        </div>
      </div>
    </Layout>
  );
