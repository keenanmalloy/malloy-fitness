...
describe('Get Sets API', function () {
  ...
  describe('Fetch sets in the session', function () {
    it('responds with 401 if missing Cookie', async function () {
      const response = await axiosAPIClient.get('/sessions/not-found/sets');
    ...
    it('responds with 200 with all sets in the session', async function () {
